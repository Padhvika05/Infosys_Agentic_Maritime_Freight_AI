...
The Agentic AI for Maritime Freight Pricing and Route Optimization is an AI-powered logistics assistant designed to simplify freight quotation, shipment analysis, and logistics decision-making through the integration of **Machine Learning**, **Large Language Models (LLMs)**, and **Retrieval-Augmented Generation (RAG)**.
...
<img width="2880" height="1784" alt="image" src="https://github.com/user-attachments/assets/3d80caa3-1a9e-48c1-9a12-40ca73d2065a" />
